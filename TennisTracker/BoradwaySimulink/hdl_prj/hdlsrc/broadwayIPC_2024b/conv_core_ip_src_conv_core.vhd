...
ARCHITECTURE rtl OF conv_core_ip_src_conv_core IS
  ...
  SIGNAL alpha_reg                        : std_logic_vector(5 DOWNTO 0);  -- ufix1 [6]
  SIGNAL Delay1_out1_hStart               : std_logic;
  SIGNAL alpha_reg_1                      : std_logic_vector(5 DOWNTO 0);  -- ufix1 [6]
  SIGNAL Delay1_out1_hEnd                 : std_logic;
  SIGNAL alpha_reg_2                      : std_logic_vector(5 DOWNTO 0);  -- ufix1 [6]
  SIGNAL Delay1_out1_vStart               : std_logic;
  SIGNAL alpha_reg_3                      : std_logic_vector(5 DOWNTO 0);  -- ufix1 [6]
  SIGNAL Delay1_out1_vEnd                 : std_logic;
  SIGNAL alpha_reg_4                      : std_logic_vector(5 DOWNTO 0);  -- ufix1 [6]
  SIGNAL Delay1_out1_valid                : std_logic;

BEGIN
  -- Delay Control signal by amount
  -- of operations to give time for
  -- valid image
  ...
  -- Boost Binarized Signal

  Constant4_out1 <= to_unsigned(16#00#, 8);

  Constant3_out1 <= to_unsigned(16#FF#, 8);
  ...
  Product_out1 <= Constant3_out1 WHEN Delay8_out1 = '1' ELSE
      to_unsigned(16#00#, 8);
  ...
  y <= Constant4_out1 & Constant4_out1 & Constant4_out1 & Constant4_out1 & Constant4_out1 & Constant4_out1 & Constant4_out1 & Delay11_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        alpha_reg(5 DOWNTO 1) <= alpha_reg(4 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS c_process;

  Delay1_out1_hStart <= alpha_reg(5);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        alpha_reg_1(5 DOWNTO 1) <= alpha_reg_1(4 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS c_1_process;

  Delay1_out1_hEnd <= alpha_reg_1(5);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        alpha_reg_2(5 DOWNTO 1) <= alpha_reg_2(4 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS c_2_process;

  Delay1_out1_vStart <= alpha_reg_2(5);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        alpha_reg_3(5 DOWNTO 1) <= alpha_reg_3(4 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS c_3_process;

  Delay1_out1_vEnd <= alpha_reg_3(5);
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        ...
        alpha_reg_4(5 DOWNTO 1) <= alpha_reg_4(4 DOWNTO 0);
      END IF;
    END IF;
  END PROCESS c_4_process;

  Delay1_out1_valid <= alpha_reg_4(5);
